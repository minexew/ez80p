...
libez80p.rar contains the C wrapper . This is a separate project that when
built will produce a .lib file that should be linked with your app. It also
includes the .h file required by your app. Finally, it also includes
"testing.xls" which indicates which of the OS calls have currently been
tested (a large chunk, but not all currently).

appone.rar contains a sample (test) application. A word of
...
Last, but not least,  cstartup.asm required by your app (also included in the
