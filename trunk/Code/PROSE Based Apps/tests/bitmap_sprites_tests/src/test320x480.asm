; test pixel doubling with 256 colour mode
...
begin_app		
				ld a,0100b
				ld (video_control),a				;256 colours, pixel doubling:on, no line doubling
				ld a,0
...
include	'stonehenge_320x480_chunky.asm'

include 'stonehenge_320x480_12bit_palette.asm'
