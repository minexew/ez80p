;----------------------------------------------------------------------------------------------
; minimal code example to set up a 640x480 256 colour display
...
bm_datafetch	equ 640			;number of bytes hardware reads from VRAM_A per line
...
bm_base			equ 0800000h	;address of the first byte of the display
				...
				ld a,00000b
				ld (video_control),a				;set 256 colour mode, pixel and line doubling off
				ld a,0
