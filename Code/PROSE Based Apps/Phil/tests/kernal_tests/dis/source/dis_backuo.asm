...
my_prog		
			call disassemble				; disassembles one "line" of code
			ret

;-----------------------------------------------------------------------------------------------

; Set IX = address to disassemble from..
...
ed_x3_z2		db 'INIR','X'+80h 		; y0
				db 'INDR','X'+80h		; y1

ed_x3_z3		db 'OTIR','X'+80h		; y0
				db 'OTDR','X'+80h		; y1
...
table_rot	db 'RL','C'+80h, 'RR','C'+80h, 'R','L'+80h, 'R','R'+80h
			db 'SL','A'+80h, 'SR','A'+80h, 'SL','L'+80h, 'SR','L'+80h
...
dis_addr		dw24 test_code

;-----------------------------------------------------------------------------------------------------

test_code		lea ix,ix+2
				lea ix,iy+2
				lea iy,ix+2
				lea iy,iy-2
				lea bc,ix+2
