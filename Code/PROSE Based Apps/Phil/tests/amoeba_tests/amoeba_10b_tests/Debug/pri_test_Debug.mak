...
#
# ZDS II Make File - pri_test project, Debug configuration
#
...
LDFLAGS = @.\pri_test_Debug.linkcmd
OUTDIR = E:\MY_OWN~1\Coding\ez80p\Code\PROSEB~1\Phil\tests\AMOEBA~1\AMOEBA~3\Debug

build: pri_test

buildall: clean pri_test

relink: deltarget pri_test

deltarget: 
	@if exist $(WORKDIR)\pri_test.lod  \
            $(RM) $(WORKDIR)\pri_test.lod
	@if exist $(WORKDIR)\pri_test.hex  \
            $(RM) $(WORKDIR)\pri_test.hex
	@if exist $(WORKDIR)\pri_test.map  \
            $(RM) $(WORKDIR)\pri_test.map
...
$(WORKDIR)\test1.obj :  \
            E:\MY_OWN~1\Coding\ez80p\Code\PROSEB~1\Phil\tests\AMOEBA~1\AMOEBA~3\src\test1.asm
	 $(AS) $(ASFLAGS) E:\MY_OWN~1\Coding\ez80p\Code\PROSEB~1\Phil\tests\AMOEBA~1\AMOEBA~3\src\test1.asm
