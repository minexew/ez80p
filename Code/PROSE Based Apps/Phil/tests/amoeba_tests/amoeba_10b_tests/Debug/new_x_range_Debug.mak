...
#
# ZDS II Make File - new_x_range project, Debug configuration
#
...
LDFLAGS = @.\new_x_range_Debug.linkcmd
OUTDIR = E:\MY_OWN~1\Coding\ez80p\Code\PROSEB~1\Phil\tests\AMOEBA~1\AMOEBA~3\Debug

build: new_x_range

buildall: clean new_x_range

relink: deltarget new_x_range
...
clean: 
	...
	@if exist $(WORKDIR)\new_x_range.map  \
            $(RM) $(WORKDIR)\new_x_range.map
	@if exist $(WORKDIR)\x_range_test1.obj  \
            $(RM) $(WORKDIR)\x_range_test1.obj
...
OBJS =  \
            $(WORKDIR)\x_range_test1.obj

new_x_range: $(OBJS)
	 $(LD) $(LDFLAGS)

$(WORKDIR)\x_range_test1.obj :  \
            E:\MY_OWN~1\Coding\ez80p\Code\PROSEB~1\Phil\tests\AMOEBA~1\AMOEBA~3\src\x_range_test1.asm
	 $(AS) $(ASFLAGS) E:\MY_OWN~1\Coding\ez80p\Code\PROSEB~1\Phil\tests\AMOEBA~1\AMOEBA~3\src\x_range_test1.asm
