...
tile_map_width	  equ 40							; x map size in tiles
tile_window_width equ 40							; x display size in tiles
tile_step		  equ 2								; each map location = 2 bytes


begin_app		ld a,00011110b
				ld (video_control),a				;tile mode:on, charmode:on, pixel doubling:on, line doubling:on
				ld a,0
...
;				xor a
				...
				ld hl,tile_map_addr					;fill 40x30 charmap 
				ld bc,40*30
				ld d,1h
				ld e,a
map_lp1			ld a,e
